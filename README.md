<h3>🚦 Indian Traffic Sign Classification using CNN</h3>
...
Loaded 13,971 images (58 classes) using ImageDataGenerator

Applied data augmentation: rotation, zoom, shifts

Built CNN model for multi-class classification

Achieved strong accuracy with stable learning curves

Ready for further deployment (Flask/Streamlit)
